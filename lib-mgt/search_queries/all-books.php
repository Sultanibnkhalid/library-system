...
if ($_SERVER['REQUEST_METHOD']=='GET') {
	$query = app_db()->Select("SELECT book.Book_ID,book.Book_Title,book.Author,book.Publishing_Date,book.status,category.Category_Name FROM book join category on book.Category_ID=category.Category_ID ;");
	if ($query) {
?>

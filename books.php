...
<head>
  ...
  <script src="js/books-scripts.js"></script>
  ...
  <nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light" aria-label="Eleventh navbar example" style="direction: ltr; background-color: #2795b6!important;padding-top:0;padding-bottom: 0;">
      ...
      <ul class="navbar-nav  mb-0 mb-lg-0 " style="padding-left: 0;width: 35%;">
       ...
       <!-- <ul class="navbar-nav  mt-2 mt-lg-0 " style="margin-right: 10px;">
         ...
         <select class="form-select form-select-md " aria-label=".form-select-md" style="direction: rtl;" >
              <option selected="" ><a href="books.php">الكتب</a></option>
              <option value="1"><a href="docs.php">الوثائق</a></option>
         </select>
         </li>
       </ul> -->
    ...
    height: 150px;">
            ...
            <div class="col p-2 d-flex flex-column position-static">
              ...
              <div>
                ...
                <input class="form-control rq" id="user-nameofuser" type="text" placeholder="هنا اسم العضو" disabled>
              </div>
              <div>
                <div class="mb-1 text-muted" style="float: right;margin-left: 10px;"> اسم المستخدم : </div>
                <input class="form-control rq" id="user-name" type="text" placeholder="هنا اسم المستخدم">
              </div>
              <div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="btn_save_profil_changes" data-bs-dismiss="modal" class="btn btn-primary">حفظ التغيرات</button>
        </div>
      </div>
    </div>
  </div>

...
<body>
        ...
        <main class="form-signin">
            <form style="direction: rtl;">
                ...
                <h1 class="h3 mb-3 fw-normal" style="text-align: center;">قم بتسجيل الدخول</h1>
                <p><i  id="error-msg" style="text-align: center; color:red" ></i></p>
...
$('#btn-login').on('click',function(event){
    ...
    $.post('login/user-login.php',{call_type:"user_login",password:$('#password').val(),username:$('#user-name').val()},function(data){
        ...
        if(data!=''){
            ...
            // window.location.href='../lib-mgt/index.php';

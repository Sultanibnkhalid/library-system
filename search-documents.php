...
.back-to-top.active {
  ...
  <body style="display: block;">
    ...
    <div class="bd-example">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex">
              <a style="padding:0;" class="navbar-brand" href="index.html">
                <img src="small_logo.png" width="80" height="80" class="d-inline-block align-top" alt="Bootstrap" loading="lazy">
              </a>
            </form>
          </div>
        </div>
      ...
      <nav id="NS" class="navbar sticky-top row rg-3 col-sm-12 " style="margin-top: 5px;top: 100px; background-color: gainsboro;margin-inline: auto;max-width: 99.5%;">
        <form method="get" action="#" class="col-md-6 col-sm-12">
            <div class="row rg-2">
                <div class="col-9">
                <input type="search" class="form-control" required name="dname">
                </div>
                <div class="col-3">
        ...
        <a href="search-books.php" role="button" class=" btn  btn-success">البحث في الكتب</a>
        <a href="search-documents.php" role="button" class="btn btn-outline-secondary link-active">البحث في الوثائق</a>
        <h4 style="float: left;">الوثائق</h4>
      ...
      <div class="row" style="height:400px; overflow:auto; padding: 30px;margin-inline: auto;max-width: 99.5%;">
        <?php include 'user_queries/search1-documents.php' ?>
